...
protected void printWarning(String warning) {
    if(warning.length()>1){
    RacerMessage warningDialog=   new RacerMessage(Mpiro.win.getFrames()[0], true);
                warningDialog.setSize(250,620);
                warningDialog.setLocation(300,150);
                warningDialog.setTitle("Warning Message");
	...
	for(int i=0;i<warning.length();i++) {
		...
		if (c==(char)9) {System.out.println();
                warningDialog.jTextArea1.append("\n");
                }
		else {
                    warningDialog.jTextArea1.append(String.valueOf(c));
